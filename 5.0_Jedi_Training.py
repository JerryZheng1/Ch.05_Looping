...
#1 make int(input("Enter a number:")
#2 total+=x
#3 change "The total is ", total)


'''
  2. Write a Python program that will use a FOR loop to print the even
     numbers from 2 to 100, inclusive (includes 2 and 100). (5pts)
'''
...
'''
  4. Write a program that prints a random integer from 1 to 10 (inclusive) (includes 1, 10). (5pts)
'''
